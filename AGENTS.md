...
OCaml SDK for ABCI 2.0 — the interface CometBFT uses to talk to the application whose state machine it replicates. Write the chain state machine in OCaml, run it behind a CometBFT consensus node.

## Where this repo sits

`~/reuna/web3/ocaml-cometbft` — the `web3/` group (OCaml/Mirage web3 protocol libraries).
